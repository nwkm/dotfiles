...
local source_mapping = {
  npm = nw.icons.terminal .. "NPM",
  nvim_lsp = nw.icons.paragraph .. "LSP",
  buffer = nw.icons.buffer .. "BUF",
  luasnip = nw.icons.snippet .. "SNP",
  path = nw.icons.folderOpen2,
  treesitter = nw.icons.tree,
  zsh = nw.icons.terminal .. "ZSH",
}
...
cmp.setup({
  ...
  mapping = cmp.mapping.preset.insert({
    ...
    ["<CR>"] = cmp.mapping.confirm({
      ...
      select = nw.plugins.completion.select_first_on_enter,
    }),
