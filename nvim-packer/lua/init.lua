...
--pcall(vim.cmd, [[colorscheme monokai-inspired]])
-- vim.cmd('colorscheme haslo')
vim.cmd('colorscheme vim-monokai-tasty')
-- vim.cmd('hi Pmenu cterm=none gui=none')
vim.cmd[[autocmd ColorScheme * highlight Pmenu guibg=NONE]]
vim.cmd[[autocmd ColorScheme * highlight Pmenu ctermbg=NONE]]
