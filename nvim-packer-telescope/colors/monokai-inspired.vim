...
let colors_name = "monokai-inspired"
...
let s:cornflower  = { "gui": "#5f87ff", "cterm": "69"  }
let s:plum        = { "gui": "#d7afff", "cterm": "183" }
let s:darkturq    = { "gui": "#00d7d7", "cterm": "44"  }
let s:darkolive   = { "gui": "#d7ff87", "cterm": "192" }
let s:pink        = { "gui": "#F92772", "cterm": "197" }
let s:green       = { "gui": "#A6E22D", "cterm": "148" }
let s:aqua        = { "gui": "#66d9ef", "cterm": "81"  }
let s:yellow      = { "gui": "#E6DB74", "cterm": "77"  }
...
call s:h("Visual",        {                     "bg": s:darkolive })
...
call s:h("NERDTreeDir",             { "fg": s:plum })
